...
export BOARD SOC ARCH ABI CPU KERNEL_BASE DT_NAME KERN_IMG KERNEL_BASE_DEFCONFIG STORAGE
export UBOOT_DEFCONFIG UBOOT_DEFCONFIG_SD BUILDROOT_DEFCONFIG LOADER_INI LOADER_TRUST_INI

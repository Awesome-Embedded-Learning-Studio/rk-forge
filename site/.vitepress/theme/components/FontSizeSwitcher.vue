...
// 模块级共享状态:本组件在顶栏与移动菜单各挂一份,实例私有 ref 会互不同步
// (假死步进、甚至反向步进),提为模块单例后两实例读写同一状态。
...
// 写 documentElement.dataset.fontSize → interactive.css 的 html[data-font-size] 用 zoom 整页缩放。

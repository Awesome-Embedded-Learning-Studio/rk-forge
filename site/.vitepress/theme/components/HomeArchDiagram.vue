...
const layers = [
  {
    ...
    label: '用户空间',
    sublabel: 'User Space',
    items: ['BusyBox shell', 'buildroot 工具集', '自定义程序']
  },
  {
    icon: '📦',
    label: '根文件系统',
    sublabel: 'RootFS',
    items: ['UBIFS · SPI-NAND', 'ext4 · SD 卡', '/bin  /sbin  /lib']
  },
  {
    icon: '🐧',
    label: 'Linux 内核',
    sublabel: 'Kernel · 主线 7.1',
    items: ['主线驱动子系统', '进程调度', '网络协议栈'],
    extras: ['板级设备树 (DTB)']
  },
  {
    icon: '🚀',
    label: 'U-Boot',
    sublabel: 'Bootloader · 主线 2026.07-rc4',
    flow: 'rkbin 点亮 DDR → 加载 DTB → 启动内核'
  },
  {
    icon: '🔧',
    label: 'Rockchip 硬件',
  ...
  <div class="home-arch">
    <div class="home-arch-inner">
      ...
      <div class="home-arch-cta">
        <a href="/rk-forge/tutorial/" class="arch-cta">
          <span>查看完整学习路线图</span>
